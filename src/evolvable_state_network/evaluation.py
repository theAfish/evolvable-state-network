...
from .candidate import EdgeArchitecture, FixedEdgeRule, MLPEdgeRule, MLPUpdateRule, RuleArchitecture
...
class CandidateEvaluator:
    ...
    def _evaluate_scenario(
        ...
        if intervention is None:
            from .torch_backend import TorchMLPSimulator, resolve_device
